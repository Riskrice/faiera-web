        ...
        <>
            <div className="space-y-6">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                    <h3 className="text-xl md:text-2xl font-bold font-cairo text-foreground">محتوى الكورس</h3>
                ...
                <div className="bg-card border border-border rounded-[20px] md:rounded-2xl overflow-hidden">
                    <Accordion type="single" collapsible className="w-full" defaultValue={chapters[0]?.id}>
                        {chapters.map((chapter) => (
                            <AccordionItem key={chapter.id} value={chapter.id} className="border-border/50 px-2">
                                <AccordionTrigger className="px-3 md:px-4 py-3.5 md:py-4 hover:no-underline hover:bg-muted/50 rounded-lg transition-colors group">
                                    <div className="flex flex-col items-start gap-1 w-full text-right">
                                        <span className="font-bold text-base md:text-lg text-foreground group-hover:text-primary transition-colors font-cairo">
                                            {chapter.title}
                                        </span>
                                ...
                                <AccordionContent className="pt-2 pb-3 md:pb-4 px-1.5 md:px-2">
                                    <div className="space-y-1">
                                        {chapter.lessons.map((lesson) => (
                                            <div
                                                ...
                                                className={cn(
                                                    "flex items-center justify-between gap-3 p-2.5 md:p-3 rounded-lg transition-all duration-200",
                                            ...
                                            >
                                                <div className="flex items-center gap-3 overflow-hidden">
                                                    ...
                                                    <span className={cn(
                                                        "text-[13px] md:text-sm font-medium truncate font-cairo",
                                                ...
                                                <div className="flex items-center gap-2 md:gap-4 shrink-0">
                                                    ...
                                                    <div className="flex items-center gap-1 text-[11px] md:text-xs text-gray-400 group-hover:text-gray-300 transition-colors min-w-[56px] md:min-w-[60px] justify-end">
