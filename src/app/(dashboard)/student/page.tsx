        ...
        <div className="flex-1 space-y-8">
            ...
            <section>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/student/courses" className="text-primary hover:underline text-sm font-medium">عرض كل الكورسات</Link>
                </div>
                ...
                {lastWatched ? (
                    <div className="bg-card border border-border rounded-xl p-4 flex flex-col md:flex-row gap-6 items-center hover:bg-muted/50 transition-colors group cursor-pointer" onClick={() => window.location.href = `/student/courses/${lastWatched.content?.courseId}/learn/${lastWatched.contentId}`}>
                        ...
                        <div className="flex-1 space-y-2 text-center md:text-right w-full">
                            <div className="text-xs font-semibold text-primary uppercase tracking-wider">استئناف الدرس</div>
                            <h3 className="text-xl font-bold">{lastWatched.content?.titleAr || lastWatched.content?.titleEn || 'درس تعليمي'}</h3>
                    ...
                    <div className="text-center py-12 bg-muted/20 rounded-xl border-2 border-dashed">
                        ...
                        <Button asChild>
                            <Link href="/student/courses">تصفح الكتالوج</Link>
                        </Button>
                    </div>
                )}
            </section>
