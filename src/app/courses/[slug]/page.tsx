                                ...
                                <div className="flex flex-col gap-4 rounded-2xl border border-border/70 bg-muted/20 p-4 md:flex-row md:items-center md:justify-between">
                                    <div className="flex items-center gap-3 md:gap-4">
                                        <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-primary/20 shrink-0">
                                            <Image src={demoCourse.author.avatar} alt={demoCourse.author.name} fill className="object-cover" unoptimized />
                                        </div>
                                        <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 md:gap-3 w-full md:w-auto">
                                        ...
                                        <div className="flex items-center gap-2 bg-background px-3 py-2 rounded-xl border border-border/70 text-sm text-foreground/80">
                                            ...
                                            <span>{demoCourse.students.toLocaleString()} طالب</span>
                                        </div>
                                        <div className="flex items-center gap-2 bg-background px-3 py-2 rounded-xl border border-border/70 text-sm text-foreground/80">
